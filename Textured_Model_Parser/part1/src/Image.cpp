...
// Load the pixel data from a PPM image.
// flip: flip the pixels upside down in the data if you use this be consistent.
...
// Returns pixel data for our image
